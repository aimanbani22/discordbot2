...
client.once('ready', () => {
	console.log('Helemaal moooi');
	client.user.setActivity('NestwijkRP', { type: 'WATCHING' });
  ...
  if (isNaN(amount)) {
    ...
    return message.reply('Je hebt niet een nummer gebruikt binnen 1-99.');
  }
  message.channel.bulkDelete(amount, true).catch(err => {
    console.error(err);
    message.channel.send('Er was een error wanneer je de prume command gebruikte!');
  });
}
})