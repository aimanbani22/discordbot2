...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    let dot = TICK_N % 2 === 0 ? 'NestwijkRP' : 'Roleplay';
    let embed = new Discord.RichEmbed()
    .setAuthor("NestwijkRP Server Status", "https://cdn.discordapp.com/attachments/781793103908306945/790237475863396382/b426395433919a12c5c22e7a0f831e09.webp")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ NestwijkRP' : '⚫ NestwijkRP')
    .setTimestamp(new Date())
    .addField('\n\u200b\nHoe kan je de server joinen?','Je kan de server joinen doormiddel van **NestwijkRP** in te voeren bij Fivem Servers.\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('NestwijkRP',{'url':'https://www.twitch.tv/RoqueTV','type':'STREAMING'});
